  ...
  return (
    <div className='container'>
        <header>
            ...
            <ul className='list'>
                <li><Link className='links text-gray-600 hover:text-gray-900' href="#">WORK</Link></li>
                <li><Link className='links text-gray-600 hover:text-gray-900' href="#">ABOUT</Link></li>
                <li><Link className='links text-gray-600 hover:text-gray-900' href="#">NEWS</Link></li>
                <li><Link className='links text-gray-600 hover:text-gray-900' href="#">THINKING</Link></li>
                <li><Link className='links text-gray-600 hover:text-gray-900' href="#">CAREERS</Link></li>
                <li><Link className='links text-gray-600 hover:text-gray-900' href="#">CONTACT</Link></li>
            </ul>
            <label class="menuButton active" for="check">
