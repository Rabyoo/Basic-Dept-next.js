  ...
  return (
    <div className='container-footer'>
      <header>
        ...
        <div className="text">
          <h1 className='text-[25px] line-clamp-4 font-bold'>We collaborate with ambitious <br /> brands and people. 
            Let's build. <br /> <a href="#" className='em underline'>biz@basicagency.com</a>
            </h1>
        </div>
      </header>
      <nav>
        <div className="input-email">
          <label className='mt-[-10px] text-xl'>STAY IN THE KNOW</label>
          <div className="input flex align-center">
            <input className='border-none w-[400px] h-[40px] bg-transparent' type="email" placeholder='Email Address' />
            <FaArrowRight className='ml-[-30px] outline-none' />
          </div>
        </div>
        <ul className="list-f">
          <h1 className=''>Title Text</h1>
          <li><Link href="#">Text</Link></li>
          <li><Link href="#">Text</Link></li>
          <li><Link href="#">Text</Link></li>
          <li><Link href="#">Text</Link></li>
        </ul>
      ...
      <footer className='footer bg-zinc-900 w-[100%] p-8 max-w-[100%]'>
        <div>
